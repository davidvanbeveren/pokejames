  ...
  // =========================================================================
  {
    ...
    M.violet_hall = {
      ...
      objects: [
        ...
        ...guestObjects,
        { type: 'npc', id: 'hall_abbie', name: 'ABBIE', sprite: 'abbie', x: 7, y: 3, dir: 'down', move: 'look', dialog: ['ABBIE: Sorry I was exposing a fish farm on national TV so I barely had time to decorate the cake! I hope you like it! Happy Birthday my love.'] },
